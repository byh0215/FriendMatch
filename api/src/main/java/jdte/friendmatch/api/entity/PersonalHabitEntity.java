...
public class PersonalHabitEntity {
    ...
    private Integer phSex;

    private Integer phTimetag;

    private Integer phArea;

    private Integer phDiffsex;
    ...
    private Integer phAnimal;

    private Integer phMusic;

    private Integer phWorkstation;

    private Integer phGame;

    private Integer phTablegame;

    private Integer phTourism;

    private Integer phHealth;

    private Integer phFood;

    private Integer phQuiet;

    private String phSkill;

    private String phCall;

    private Integer phOpen;
    ...
    public void setPhSkill(String phSkill) {
        this.phSkill = phSkill == null ? null : phSkill.trim();
    }
    ...
    public void setPhCall(String phCall) {
        this.phCall = phCall == null ? null : phCall.trim();
    }
